  ...
  return (
    <AnimatePresence>
      {project && (
        <motion.div
          ref={modalRef}
          className="project-modal fixed inset-0 z-30 overflow-y-auto bg-white text-black"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
        ...
        >
          <button
            ...
            className="fixed right-0 top-0 z-40 flex h-14 w-14 items-center justify-center text-4xl leading-none text-black md:h-16 md:w-16 md:text-[2.5rem]"
          >
            <span aria-hidden="true">×</span>
          </button>

          <section className="relative flex h-screen min-h-[560px] items-center justify-center overflow-hidden bg-white px-5 py-16 md:px-12 md:py-20">
            <motion.div
          ...
          <section
            ref={infoRef}
            className="flex min-h-[50vh] items-start bg-white px-6 py-20 md:px-10 md:py-28"
          >
          ...
          <section className="flex h-[20vh] min-h-36 items-center justify-center bg-white">
            <button
              type="button"
              onClick={onClose}
              className="min-h-11 px-5 text-xs tracking-[0.3em] text-black/60 hover:text-black md:text-sm"
            >
              close
            </button>
          </section>
